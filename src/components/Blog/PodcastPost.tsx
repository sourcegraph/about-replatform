...
export const PodcastPost: React.FunctionComponent<Props> = ({
    ...
    const { guestsHTML = '', summaryHTML = '', audioHTML = '', showNotesHTML = '', transcriptHTML = '' } = getHTMLParts('')
    return (
        <Tag className={`podcast-post ${className}`}>
            ...
            {summaryHTML && (
                <div className="card-body podcast-post__body pt-0 pb-0">
                    {summaryHTML}
                </div>
            )}
            <div className="card-body">
                {audioHTML && (
                    <div className="podcast-post__body audio-container">
                        {audioHTML}
                    </div>
                )}
            ...
            {full && (
                <>
                    {showNotesHTML && (
                        <div className="card-body border-top">
                            <h3 className="h4 mb-3">
                                <a href="#notes" id="notes">Show notes</a>
                            </h3>
                    ...
                    {transcriptHTML && (
                        <div className="card-body border-top">
                            <h3 className="h4 mb-3">
                                <a href="#transcript" id="transcript">Transcript</a>
                            </h3>
